...
import net.sb.gecomp.orm.dao.AtletaDao;
import net.sb.gecomp.orm.dao.CategoriaDao;
import net.sb.gecomp.orm.dao.CategoriaGaraDao;
import net.sb.gecomp.orm.dao.CompetizioneDao;
import net.sb.gecomp.orm.dao.GaraDao;
import net.sb.gecomp.orm.dao.IscrizioneDao;
import net.sb.gecomp.orm.dao.PrestazioneDao;
import net.sb.gecomp.orm.dao.PropertiesDao;
import net.sb.gecomp.orm.dao.SocietaDao;
import net.sb.gecomp.orm.dao.TipoMisuraDao;
import net.sb.gecomp.orm.dao.TipoPrestazioneDao;
