...
CREATE TABLE IF NOT EXISTS `iscrizione` (
  ...
  PRIMARY KEY `ISCRIZIONE_KEY`  (`ID_ISCRIZIONE`,`GARA`,`ATLETA`),
  UNIQUE  KEY `ISCRIZIONE_KEY`  (`ID_ISCRIZIONE`,`GARA`,`ATLETA`),
  UNIQUE  KEY `GARA_ATLETA_KEY` (`GARA`,`ATLETA`),
  UNIQUE  KEY `GARA_PETTORALE_KEY` (`GARA`,`NUMERO_PETTORALE`)
